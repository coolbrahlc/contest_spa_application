...
const { CUSTOMER_ROLE, CREATIVE_ROLE, TAGLINE_TYPE, LOGO_TYPE, ENTRY_CONFIRMED } = require('../../utils/consts');
...
module.exports.getContestsById =  async (req, res , next) => {
    try {
        ...
        contest.dataValues.Suggestions = await db.Suggestions.findAll({
              where: {contest_id: req.params.id, moderation_status: ENTRY_CONFIRMED},
              include: [{
                  model: db.Users,
                  attributes: ['full_name', 'profile_picture', 'email', 'id'],
              }],
        ...
        //     }
        // }
        //console.log(contest.Suggestions /*[0].dataValues*/, 5555)
...
module.exports.getContests =  async (req, res , next) => {
    const { params, offset, name } = req.body;
    //console.log(params, offset, name )
